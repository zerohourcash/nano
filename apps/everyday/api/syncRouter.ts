...
export const syncRouter = createRouter({
  ...
  audit: publicQuery.query(async () => ({
    ...
    itemStateError: null as string | null,
    ...
    writeoffError: null as string | null,
    writeoffsVerified: 0,
    writeoffsLegacy: 0,
    stockOperationError: null as string | null,
    stockOperationsVerified: 0,
    stockOperationsLegacy: 0,
    membershipError: null as string | null,
    membershipVerified: true,
    interorgInboxVerified: 0,
    interorgInboxLegacy: 0,
    interorgInboxError: null as string | null,
    interorgReceiptsVerified: 0,
    interorgReceiptError: null as string | null,
