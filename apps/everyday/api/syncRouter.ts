...
export const syncRouter = createRouter({
  ...
  audit: publicQuery.query(async () => ({
    ...
    pendingDownloads: 0,
    counts: { workspaces: 0, users: 0, devices: 0, custodyEntries: 0, itemTombstones: 0, itemComments: 0, faultRecords: 0, items: 0, history: 0, messages: 0, organizationNodes: 0, blobs: 0, accountingTransactions: 0, accountingLines: 0, knowledgePages: 0, knowledgeRevisions: 0, membershipVersions: 0 },
