...
| Android BLE GATT | foreground advertiser/server + scanner/client, MTU/retry, bounded crash-safe ciphertext spool, authorized import handoff, persistent diagnostics | Rust API regression, Android compile/lint, lifecycle/spool contract, APK | Реализовано; RF/lifecycle-тест на двух телефонах не выполнен |
