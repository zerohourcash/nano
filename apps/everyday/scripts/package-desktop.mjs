...
if (sourceDirty && process.env.EVERYDAY_ALLOW_DIRTY_RELEASE !== "1") {
  throw new Error(
    "Refusing to package a dirty tracked worktree; commit or explicitly set EVERYDAY_ALLOW_DIRTY_RELEASE=1"
  );
}
...
const manifest = {
  format: "everyday-desktop-release/v2",
  sourceRevision,
  sourceDirty,
  platform,
  arch,
